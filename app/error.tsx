...
export default function RootError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col justify-center items-center px-4 font-sans transition-colors duration-200">
      <div className="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-2xl p-8 max-w-md w-full shadow-lg text-center space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-black text-gray-900 dark:text-white">Something went wrong!</h2>
          <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
            An unexpected error occurred while rendering this page. If this persists, please contact support or return to the main lobby.
          </p>
        </div>
